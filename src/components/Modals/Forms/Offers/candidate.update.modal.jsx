...
const urlOfertas = api + "/api/ofertas/oferta";
const urlEstadoDeContrato = api + "/api/ofertas/estado_contrato";
const urlProveedor = api + "/api/proveedores/proveedor";
						...
						<div className="input-group has-validation mt-3">
							...
							<div className="form-floating">
								<select
									...
									name="SelectState"
									defaultValue={
										empty ? "" : data.id_ContratingStatus
									}
								>
