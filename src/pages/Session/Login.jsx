...
import { formatReadableDate, getSesion } from "../../utils/Functions";
					...
					return (
						<div className="card" key={neww.id}>
							<div className="header-card-img">
								<img src={neww.image} alt="imagen noticia" />
								<h3>{neww.title}</h3>
							</div>
							<p>{neww.text}</p>
							<div className="date-autor-new">
								<h5>{neww.author}</h5>
								<p>{formatReadableDate(neww.publish_date)}</p>
							</div>
							<a
								href={neww.url}
								target="_blank"
